...
public class MapsMyLocationActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBack = findViewById(R.id.ic_back_myLocation);

        mBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MapsMyLocationActivity.this, MainActivity.class);
