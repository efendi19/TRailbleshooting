...
public class Anu2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anu2);
        ...
        if (cameraIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (pictureFile != null) {
                Uri photoURI = FileProvider.getUriForFile(this,
                        "com.tehkotak.trailbleshooting.fileprovider",
                        pictureFile);
    ...
    private void addToCloudStorage() {
        ...
        StorageReference uploadeRef = storageRef.child("Data Gambar/" + UUID.randomUUID().toString());
